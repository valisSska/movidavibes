...
class Wprentals_Recent_Items_Slider_v3 extends Widget_Base {
	...
	public function get_name() {
            return 'Wprentals_Recent_Items_Slider_v3';
	}
	...
	public function get_title() {
		return __( 'WpRentals Recent Item Slider v3', 'rentals-elementor' );
	}
		...
		$this->end_controls_section();
		        ...
		        */
		        ...
		        $this->add_control(
		            'hide_categories',
		            [
		                                    'label' => esc_html__('Hide Details', 'rentals-elementor'),
		                                    'type' => Controls_Manager::SWITCHER,
		                                    'label_on' => esc_html__('Yes', 'rentals-elementor'),
		                                    'label_off' => esc_html__('No', 'rentals-elementor'),
		                                    'return_value' => 'none',
		                                    'default' => '',
		                                    'selectors' => [
		                                            '{{WRAPPER}}  .category_tagline.custom_details' => 'display: {{VALUE}};',
		                                    ],
		                            ]
		        );
		        ...
		        */
		        ...
		        $this->add_responsive_control(
		            ...
		            [
		                     'label' => esc_html__('Property Category Margin Bottom(px)', 'rentals-elementor'),
		                     'type' => Controls_Manager::SLIDER,
		                     'range' => [
		                         'px' => [
		                             'min' => 0,
		        ...
		        $this->add_responsive_control(
		            ...
		            [
		                                     'label' => esc_html__('Property Description Margin Bottom(px)', 'rentals-elementor'),
		                                     'type' => Controls_Manager::SLIDER,
		                                     'range' => [
		                                             'px' => [
		                                                     'min' => 0,
		                                     ...
		                                     'selectors' => [
		                                             '{{WRAPPER}} .category_tagline.custom_details ' => 'margin-bottom: {{SIZE}}{{UNIT}};',
		                                     ],
		                             ]
		        );
		        ...
		        $this->add_responsive_control(
		            ...
		            [
		                                                 ...
		                                                 'selectors' => [
		                                                     '{{WRAPPER}} .category_tagline.map_icon:after,{{WRAPPER}} .category_tagline.actions_icon:after,.custom_listing_data i' => 'font-size: {{SIZE}}{{UNIT}};',
		                                                 ],
		                                             ]
		        );
		        ...
		        */
		        ...
		        $this->add_control(
		            ...
		            [
			            ...
			            'price_back_color',
			            [
			                           'label'     => esc_html__('Price Background Color', 'rentals-elementor'),
			                           'type'      => Controls_Manager::COLOR,
			                           'default'   => '',
			                           'selectors' => [
			                               '{{WRAPPER}} .price_unit' => 'background-color: {{VALUE}}',
			                           ],
			                       ]
			        );
