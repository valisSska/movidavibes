...
class Wprentals_Featured_Listing extends Widget_Base {
	...
	public function get_name() {
		return 'Wprentals_Featured_Listing';
	}
	...
	public function get_title() {
		return __( 'WpRentals Featured Listing', 'rentals-elementor' );
	}
	...
	protected function render() {
		$settings = $this->get_settings_for_display();
                $attributes['id']    =   $settings['listing_id'];
