...
class Wpestate_Contact_widget extends WP_Widget {
	...
	function widget($args, $instance){
		...
		if($instance['address_info']){
                    ...
                    $display.='<p class="widget_contact_addr"><i class="fas fa-home"></i>'.$co_address.'</p>';
		}
		...
		if($instance['phone_no']){
                    ...
                    $display.='<p class="widget_contact_phone"><i class="fas fa-phone"></i><a href="tel:'.urlencode( $co_phone_no ).'">'.$co_phone_no.'</a></p>';
		}
		...
		if($instance['fax_no']){
                    ...
                    $display.='<p class="widget_contact_fax"><i class="fas fa-print"></i>'. $co_fax_no .'</p>';
		}
		...
		if($instance['email']){
                    ...
                    $display.='<p class="widget_contact_email"><i class="far fa-envelope"></i><a href="mailto:'.esc_html($co_email).'">'.esc_html($co_email).'</a></p>';
		}
		...
		if($instance['skype']){
                    ...
                    $display.='<p class="widget_contact_skype"><i class="fab fa-skype"></i>'.$co_skype.'</p>';
		}
		...
		if($instance['website_url'] && $instance['website_url_text']){
                    ...
                    $display.='<p class="widget_contact_url"><i class="fas fa-desktop"></i><a href="'.$co_website_url.'">'.$co_website_url_text.'</a></p>';
		}
		$display.='</div>';
		print $display;
		print $after_widget;
