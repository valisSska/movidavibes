...
export const editSectionHeroVideo = ({ className, attributes, setAttributes }) => {
...
export const saveSectionHeroVideo = ({ attributes }) => (
  <div id={attributes.name} style={{ backgroundColor: attributes.backgroundColor }}>
    ...
    >
      <div className="row">
        <div className="col-12 col-md-5 section-hero-video-left-side">
