...
function post_tedesco_ctp()
{
  $labels = [
      'all_items'          => __('All', 'pro-terra-sancta-fixed'),
      'update_item'        => __('Update', 'pro-terra-sancta-fixed'),
      'name'               => __('Tedesco', 'pro-terra-sancta-fixed'),
      'singular_name'      => __('Tedesco', 'pro-terra-sancta-fixed'),
      'add_new'            => __('Add new', 'pro-terra-sancta-fixed'),
      'add_new_item'       => __('Tedesco', 'pro-terra-sancta-fixed'),
      ...
      'menu_name'          => __('Tedesco', 'pro-terra-sancta-fixed'),
  ];

  $args = [
      'label'               => __('tedesco', 'pro-terra-sancta-fixed'),
      'description'         => __('Tedesco', 'pro-terra-sancta-fixed'),
      'labels'              => $labels,
      'supports'            => [
          'title',
          'editor',
...
add_action('init', 'post_tedesco_ctp', 0);
