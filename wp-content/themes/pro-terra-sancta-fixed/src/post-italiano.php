...
function post_italiano_ctp()
{
  $labels = [
      'all_items'          => __('All', 'pro-terra-sancta-fixed'),
      'update_item'        => __('Update', 'pro-terra-sancta-fixed'),
      'name'               => __('Italiano', 'pro-terra-sancta-fixed'),
      'singular_name'      => __('Italiano', 'pro-terra-sancta-fixed'),
      'add_new'            => __('Add new', 'pro-terra-sancta-fixed'),
      'add_new_item'       => __('Italiano', 'pro-terra-sancta-fixed'),
      ...
      'menu_name'          => __('Italiano', 'pro-terra-sancta-fixed'),
  ];

  $args = [
      'label'               => __('italiano', 'pro-terra-sancta-fixed'),
      'description'         => __('Italiano', 'pro-terra-sancta-fixed'),
      'labels'              => $labels,
      'supports'            => [
          'title',
          'editor',
...
add_action('init', 'post_italiano_ctp', 0);
