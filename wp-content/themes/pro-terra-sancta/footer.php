...
global $constvalue;
global $translations;
$footer_links = get_footer_locate_links($lang);
global $suff;
global $language;
include get_stylesheet_directory() . '/lang/label-' . $suff . '.php';
$header = $translations['header'];
$footer_trad = $translations['footer'];
            ...
            <div class="container py-4">
                ...
                <div class="row pb-0 pb-lg-0">
                    ...
                    <div class="col-lg-6 col-md-12 mb-0 mb-md-0">
                      <div class="fit-content m-auto m-lg-0 text-center text-lg-left">
                        <h3 class="text-uppercase text-company animate-up"><?php echo $footer_trad['title']->$lang; ?></h3>
                        <h4 class="text-company-sub animate-up-delay-100"><?php echo $footer_trad['motto']->$lang; ?></h4>
                        <div class="text-address-footer"><b><?php echo $footer_trad['sede2']->$lang; ?></b> <?php echo $footer_trad['sede2desc']->$lang; ?></div>
                        <div class="text-address-footer"><b><?php echo $footer_trad['sede1']->$lang; ?></b> <?php echo $footer_trad['sede1desc']->$lang; ?> | <b>Tel: +39 026572453</b></div>
                        <div class="text-address-footer"><b><?php echo $footer_trad['sede3']->$lang; ?></b> <?php echo $footer_trad['sede3desc']->$lang; ?> | <a style="color: #f9ba55"  class="font-weight-bold" href="https://www.proterrasancta.org.uk" target="_blank">website</a></div>
                        <div class="row mt-3 no-gutters d-none d-lg-block">
                          <ul class="social-circle social-circle-footer m-auto m-md-0">
                            <li>
                              <a href="<?php echo $header['facebook']->$lang; ?>"
                                ...
                                <img class="icon-footer-social" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona_facebook.png" alt="icon-facebook" />
                              </a>
                            </li>
                            <li>
                              <a href="https://twitter.com/proterrasancta" title="Segui su Twitter" target="_blank">
                                <img class="icon-footer-social" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona_twitter.png" alt="icon-twitter" />
                              </a>
                            </li>
                            <li>
                              <a href="https://www.instagram.com/proterrasancta/" title="Segui su Instagram"
                                 target="_blank">
                                <img class="icon-footer-social" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona_instagram.png" alt="icon-instagram" />
                              </a>
                            </li>
                            <li>
                              <a href="https://www.youtube.com/proterrasancta" title="Segui su Youtube"
                                 target="_blank">
                                <img class="icon-footer-social" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona_youtube.png" alt="icon-youtube" />
                              </a>
                            </li>
                            <li>
                              <a href="https://www.linkedin.com/company/pro-terra-sancta/"
                                 title="Segui su LinkedIn" target="_blank">
                                <img class="icon-footer-social" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona_linkedin.png" alt="icon-linkedin" />
                              </a>
                            </li>
                          </ul>
                          <a href="mailto:info@proterrasancta.org" class="mail-footer m-auto m-md-0 pl-3 pt-3 pt-md-1">
                              ...
                              <g data-name="Livello 2">
                                <g fill="#f9ba55" data-name="FOOTER STANDARD">
                                  <text font-family="OpenSans-Bold,Open Sans" font-size="10" font-weight="700"
                                        transform="translate(43.42 29.49)"><?php echo $footer_trad['scrivici']->$lang; ?>
                                  </text>
                    ...
                    <div class="col-lg-6 col-md-12 mb-4 mb-md-0 d-none d-lg-block">
                      <div class="logos-donate m-auto mr-lg-0 ml-lg-auto">
                        <div>
                          <div class="row fit-content no-gutters m-auto ml-lg-auto mr-lg-0">
                            <div class="icons-footer row justify-content-center" style="width: 245px">
                              <a href="<?php echo $footer_links['campagne']->$lang; ?>"><img class="icon-footer" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona-campagne.png" alt="icon-campaign" /></a>
                              <a href="<?php echo $footer_links['conservazione']->$lang; ?>"><img class="icon-footer" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona-conservazione.png" alt="icon-campaign" /></a>
                              <a href="<?php echo $footer_links['emergenze']->$lang; ?>"><img class="icon-footer" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona-emergenze.png" alt="icon-campaign" /></a>
                              <a href="<?php echo $footer_links['istruzione']->$lang; ?>"><img class="icon-footer" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona-istruzione.png" alt="icon-campaign" /></a>
                              <a href="<?php echo $footer_links['itinerari']->$lang; ?>"><img class="icon-footer" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona-itinerari.png" alt="icon-campaign" /></a>
                              <a href="<?php echo $footer_links['progetti']->$lang; ?>"><img class="icon-footer" src="<?php echo get_stylesheet_directory_uri(); ?>/images/icona-progetti.png" alt="icon-campaign" /></a>
                            </div>
                              <div class="dona-big d-none d-md-block" style="width: 133px; height: 133px">
                              <div class="row align-items-center h-100">
                                <div class="col-12" style="height: 45px; padding-top: 10px">
                                  <a href="<?php echo $header_links['dona_btn']->$lang; ?>">
                                    <?php
                                    if ( $lang == 'it' || $lang == 'es' ): ?>
                                      <span style="font-size: 38px"><?php echo $header['dona_btn']->$lang; ?></span>
                                    <?php elseif ( $lang == 'fr' ): ?>
                                      <span style="font-size: 16px"><?php echo $header['dona_btn']->$lang; ?></span>
                                    <?php else: ?>
                                      <span style="font-size: 26px"><?php echo $header['dona_btn']->$lang; ?></span>
                                    <?php endif; ?>
                                  </a>
                                </div>
                                <div class="col-12">
                                  <a href="<?php echo $header_links['dona_btn']->$lang; ?>">
                                    <img class="donate-hand" style="width: 135px" src="<?php echo get_stylesheet_directory_uri(); ?>/images/hand.png" alt="donate-hand" />
                                  </a>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="d-none d-md-block">
                            <div class="mt-4 row justify-content-end no-gutters">
                              <?php
                              if ( $lang == 'it' ): ?>
                                <div class="img-giornalino pt-4 pt-md-0 pt-lg-0 pt-xl-0">
                                  <a href="<?php echo $footer_links['giornalino']->$lang; ?>">
                                ...
                                <div class="text-giornalino fit-content">
                                  <a href="<?php echo $footer_links['giornalino']->$lang; ?>" style="color: white">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-sm-6">
                            <p class="text-copyright text-center text-md-left">
                                Codice Fiscale 97275880587 - C.C. POSTALE n. 1012244214
                            </p>
                        </div>
                        <div class="col-12 col-sm-6 text-privacy-footer text-center text-md-right">
                            <a href="<?php echo $footer_links['privacy']; ?>"> privacy policy </a> -
                            <a href="<?php echo $footer_links['news']->$lang; ?>"> news </a> -
                            <a href="<?php echo $footer_links['presscontacts']->$lang; ?>"> press </a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php if (
	...
	! $_COOKIE['cookies_policy2'] &&
	! $_POST['ock']
): ?>
    <div id="cookie_banner">
        <div class="wrappersmall textpostpad7">
			<?php echo $language['cookie_banner']; ?>
            <div class="moz buttondiv"><a id="accept_cookie" class="ease buttonlink"
                                          href="#"><?php echo $language['cookie_accetto']; ?></a>&nbsp;&nbsp;<a
                        id="deny_cookie" class="ease buttonlink" href="#"><?php echo $language['cookie_rifiuto']; ?></a>
            </div>
        </div>
    </div>
    <form id="cookie_form" name="cookie_form" method="POST" style="display:none;"><input type="hidden" name="ock"
                                                                                         value="1"></form>
<?php endif; ?>


    <script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/node_modules/jquery/dist/jquery.min.js"></script>

    <script src="<?php echo get_stylesheet_directory_uri(); ?>/js/jquery.magnific-popup.min.js"></script>
    <script src="<?php echo get_stylesheet_directory_uri(); ?>/footer7.js" type="text/javascript"></script>
    <script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/node_modules/popper.js/dist/umd/popper.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.6.2/js/bootstrap-select.min.js"></script>
    <script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/node_modules/bootstrap/dist/js/bootstrap.min.js"></script>
    <script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/main.min.js"></script>
    </body>
    </html>

<?php function get_footer_locate_links($lang) {
	$toRet                  = [];
	$toRet['news']          = ATS::get_footer_news_btn_links();
	$toRet['stampa']        = new StdClass();
	$toRet['dona_btn']      = ATS::get_footer_header_dona_btn_links();
	$toRet['giornalino']    = ATS::get_footer_journal_btn_links();
	$toRet['presscontacts'] = ATS::get_footer_presscontacts_btn_links();
	$toRet['privacy']       = ATS::get_privacy_policy_link($lang);
	$toRet['progetti']      = ATS::get_footer_projects_btn_links();
	$toRet['campagne']      = ATS::get_footer_campagne_btn_links();
	$toRet['conservazione'] = ATS::get_footer_projects_btn_links();
	$toRet['emergenze']     = ATS::get_footer_projects_btn_links();
	$toRet['itinerari']     = ATS::get_footer_itinerari_btn_links();
	$toRet['istruzione']    = ATS::get_footer_projects_btn_links();
