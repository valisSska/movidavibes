...
/* harmony import */ var _components_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components.css */ "./src/components/components.css");
...
function MoviAllert(elems) {
  var _useState = (0,react__WEBPACK_IMPORTED_MODULE_2__.useState)(false),
    ...
    Moviallert = _useState2[0],
    setMoviallert = _useState2[1];
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Fragment, null, Moviallert === true ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("p", null, text), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)("button", {
    onClick: pressOk
  }, "OK")) : null);
}
/* harmony default export */ __webpack_exports__["default"] = (MoviAllert);
...
/* harmony import */ var _components_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components.css */ "./src/components/components.css");
/* harmony import */ var _Movi_allert__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Movi-allert */ "./src/components/Movi-allert.js");
...
var MoviSignUp = function MoviSignUp() {
  ...
  var _useState5 = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(''),
    ...
    userSurname = _useState6[0],
    setUserSurName = _useState6[1];
  var _useState7 = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(''),
    _useState8 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_useState7, 2),
    userNicename = _useState8[0],
    setUserNicename = _useState8[1];
  var _useState9 = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(false),
    _useState10 = (0,_babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1__["default"])(_useState9, 2),
    userNicenameError = _useState10[0],
    setUserNicenameError = _useState10[1];
  ...
  var _useState15 = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(''),
    ...
    userPassword2 = _useState16[0],
    setUserPassword2 = _useState16[1];
  var _useState17 = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(false),
    ...
    userPasswordControl = _useState18[0],
    setUserPasswordControl = _useState18[1];
  var _useState19 = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(''),
    ...
    textError = _useState20[0],
    setTextError = _useState20[1];
  var _useState21 = (0,react__WEBPACK_IMPORTED_MODULE_4__.useState)(false),
    ...
    emailError = _useState22[0],
    setEmailError = _useState22[1];
  var handlePhoneNumberChange = function handlePhoneNumberChange(e) {
    // Rimuovi tutti i caratteri non numerici
    var inputPhoneNumber = e.target.value.replace(/\D/g, '');

    // Limita la lunghezza massima a 10 caratteri
    var truncatedPhoneNumber = inputPhoneNumber.slice(0, 10);
    setPhoneNumber(truncatedPhoneNumber);
  };
  var controlUserNameExist = /*#__PURE__*/function () {
    var _ref = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee() {
      var userData, jsonData, responseUsers, responseUsersText;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return fetch("/wp-json/movidavibes-api/v1/exist-user", {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json'
              },
          ...
          case 9:
            responseUsersText = _context.sent;
          ...
          case 15:
            ...
            console.error('Errore nell\'invio dei dati a PHP:', _context.t0);
          case 18:
          case "end":
    ...
    return function controlUserNameExist() {
      return _ref.apply(this, arguments);
    };
  }();
  var controlUserEmailExist = /*#__PURE__*/function () {
    var _ref2 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee2() {
      var userData, jsonData, responseEmail, responseEmailText;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            console.log('Dati JSON inviati:', jsonData);
            _context2.next = 6;
            return fetch("/wp-json/movidavibes-api/v1/exist-email", {
              method: 'POST',
              headers: {
                'Content-Type': 'application/json'
              },
          ...
          case 6:
            ...
            _context2.next = 9;
            return responseEmail.text();
          case 9:
            responseEmailText = _context2.sent;
            // Leggi la risposta come testo
          ...
          case 15:
            ...
            console.error('Errore nell\'invio dei dati a PHP:', _context2.t0);
          case 18:
          case "end":
    ...
    return function controlUserEmailExist() {
  ...
  var handleRegistration = /*#__PURE__*/function () {
    var _ref3 = (0,_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_0__["default"])( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().mark(function _callee3() {
      var regexuserPassword, emailRegex;
      return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_3___default().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            regexuserPassword = /^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[a-zA-Z0-9@$!%*?&]+$/;
            emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", {
    ...
    className: "text-welcome-login-forms"
  }, "Registrati")), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("p", {
    className: "text-welcome-login-forms"
  }, "Benvenuto su Movidavibes"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", {
    className: "container-inputs-login-forms"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", {
    ...
    value: userSurname,
    onChange: function onChange(e) {
      return setUserSurName(e.target.value);
    }
  })), userNicenameError === true ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("input", {
    className: "input-password-SignUp-forms ".concat(userNicenameError ? 'error' : ''),
    style: {
      backgroundColor: '#FFF0F5',
      border: 'solid #e31c5f 1px'
    },
    placeholder: "User",
    value: userNicename,
    onChange: function onChange(e) {
      return setUserNicename(e.target.value);
    }
  }) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("input", {
  ...
  }), emailError === true ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("input", {
    className: "input-password-SignUp-forms ".concat(emailError ? 'error' : ''),
    style: {
      backgroundColor: '#FFF0F5',
      border: 'solid #e31c5f 1px'
    },
  ...
  }), userPasswordControl === true ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("input", {
    className: "input-password-SignUp-forms ".concat(userPasswordControl ? 'error' : ''),
    type: "password",
    placeholder: "Password",
    value: userPassword,
    onChange: function onChange(e) {
    ...
    style: {
      backgroundColor: '#FFF0F5',
      border: 'solid #e31c5f 1px'
    } // Utilizzo delle parentesi graffe per creare un oggetto stile
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("input", {
    className: "input-password-login-forms ".concat(userPasswordControl ? 'error' : ''),
    type: "password",
    placeholder: "Conferma Password",
    value: userPassword2,
    onChange: function onChange(e) {
      return setUserPassword2(e.target.value);
    },
    style: {
      backgroundColor: '#FFF0F5',
      border: 'solid #e31c5f 1px'
    } // Utilizzo delle parentesi graffe per creare un oggetto stile
  })) : (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("input", {
  ...
  }))), textError && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("p", {
    className: "text-privacy-login-forms",
    style: {
      color: '#e31c5f'
    }
    ...
    className: "text-privacy-login-forms"
  }, "Informativa sulla Privacy"), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.createElement)("div", {
    className: "container-button-login-forms"
