...
}else if( $page_template == 'user_dashboard_my_reviews.php' ){
    $activemyreviews  =   'user_tab_active';
}else if( $page_template == 'user_dashboard_edit_listing.php' ){
    $activemyreservations  =   'user_tab_active';
...
<div class="user_tab_menu col-md-3" id="user_tab_menu_container">
    ...
    <div class="user_dashboard_links">
        ...
        <?php if( $dash_my_reviews!=$home_url  && $dash_my_reviews!=""  && wpestate_check_user_level() ){ ?>
            <a href="<?php print esc_url($dash_my_reviews);?>" class="<?php print esc_attr($activemyreviews); ?>"><i class="fa-solid fa-chart-simple"></i><?php esc_html_e('My Reviews','wprentals');?></a>
        <?php } ?>
