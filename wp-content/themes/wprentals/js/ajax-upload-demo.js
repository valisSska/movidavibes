     ...
     "use strict";
      ...
      if (typeof(plupload) !== 'undefined') {
            ...
            uploader.bind('FileUploaded', function (up, file, response) {
                ...
                if (result.success) {       
                    $('.import_mess').empty();
                    $('#upload-container').prepend('<div class="template-item"><div class="template-wrapper"><img src="'+ajax_upload_demo_vars.destination_path+template+'/preview.jpg" /><div class="activate_wrapper"><div class="activate_template" data-baseid="'+template+'">Activate</div><div class="importing_mess">click activate in order to import</div></div></div></div>');
            ...
            $('#aaiu-uploader-demo').on('click',function (e) {
                e.preventDefault();
                e.stopPropagation();
                uploader.start();
            });
